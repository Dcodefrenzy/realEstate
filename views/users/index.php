...
<html lang="en">
<head>
<title>Praisegate Homes | Home</title>
...
<meta name="keywords" content="Real Estate Responsive website Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, Sony Ericsson, Motorola web design" />
		...
		<div class="container">
			...
			<nav class="navbar navbar-inverse">
			  <div class="container-fluid">
				...
				<div class="logo">
					<h1><a href="index.html">PraiseGate Homes</a></h1>
				</div>	
				</div>
		...
		<div class="carousel-inner" role="listbox">
			<div class="item active"> 
				<div class="container">
					<div class="carousel-caption">
						<h3>Welcome To PraiseGate Homes Limited</h3>
						<p>Buying and selling of land in Nigeria, especially in the urban and suburban cities, is the most risky aspect, But here at PraiseGate we will help you accomplish your dreams.</p>
			...
			<div class="item item3"> 
				<div class="container">
					<div class="carousel-caption">
						<h3>Smart Planning</h3>
						<p>Feel free to take a trip on our website.</p>
								...
								<li>
									<div class="col-md-6 agileits">
										...
										<div class="Pro-img-w3ls">		
											<img src=<?php echo $file_path; ?> alt="W3layouts Agileits">
										</div>
										<!-- //Slider -->								
									</div>
									<div class="col-md-6 pro-details-w3layouts">
										<h3>Property Details :<?php echo $property; ?></h3>	
										<label></label>
										<p class="location"><strong>Location :</strong>   <?php echo $location; ?></p>
										<p class="location"><strong>Location :</strong>   <?php echo $price; ?></p>
										<ol class="agileits-prolist">
											<li><i class="fa fa-long-arrow-right" aria-hidden="true"></i> <?php echo $des; ?></li>
			...
			<div class="container">
				...
				<div class="wthree_w3l_grids">
					...
					<div class="col-md-6 wthree_w3l_grid wow fadeInRight animated" data-wow-delay=".5s">
						...
						<div class="col-xs-9 wthree_w3l_grid-right">
							<h4>Rentals</h4>
							<p>We have available houses for rent.</p>
						</div>
						<div class="clearfix"> </div>
					</div>
					<div class="clearfix"> </div>
				...
				<div class="wthree_w3l_grids">
					<div class="col-md-6 wthree_w3l_grid wow fadeInLeft animated" data-wow-delay=".5s">
						...
						<div class="col-xs-9 wthree_w3l_grid-right">
							<h4>Office spaces</h4>
							<p>Several office space p for grabs.</p>
						</div>
						<div class="clearfix"> </div>
					</div>
					<div class="col-md-6 wthree_w3l_grid wow fadeInRight animated" data-wow-delay=".5s">
...
<!-- //main-content -->
	...
	<footer>	
		...
		<div class="mckodev-copyright">
			<p class="footer">&copy; 2016 Estate Group. All Rights Reserved | Design by <a href="http://w3layouts.com/">Mckodev</a></p>
		</div>
	</footer>
	<!-- //footer -->
