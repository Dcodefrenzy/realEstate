...
<input class="form-control input-md" id="property" name="property" placeholder="Write a suitable property name"  type="text" required>
</div>
<div class="form-group mb30">
...
<label class="control-label">Price</label>
 <input class="form-control input-md" name="price" id="price" placeholder="Enter price  here"  type="numbers" required>
</div>

<div class="form-group mb30">
<label class="control-label" for="textarea">description</label>

<textarea class="form-control" id="description" name="description" placeholder="Write brief information here" rows="4" required></textarea>
</div>
  <br/>
      <div class="col-md-4 col-sm-4 col-xs-12 search-bar search-bar-nostyle">
<div class="input-group-addon search-category-container">
<label class="control-labell">Property Category</label>  
...
<br/>
 ...
 <div class="col-md-4 col-sm-4 col-xs-12 search-bar search-bar-nostyle">
<div class="input-group-addon search-category-container">
<label class="control-labell">Property Status</label>  
