...
<input class="form-control input-md" id=<?php echo $hash_id ?> name="title" placeholder="Write a suitable title for your article"  type="text" required value=<?php echo $title; ?>>
</div>
<div class="form-group mb30">
<label class="control-label">Author Name</label>
 <input class="form-control input-md" name="author" id="author" placeholder="Enter Authors fullname here"  type="text" required value=<?php echo $author; ?>>

<div class="form-group mb30">
<label class="control-label" for="textarea">Body</label>

<textarea class="form-control" id="body"  name="body" placeholder="Write your article here" rows="4" required ><?php echo $body; ?></textarea>
</div>
  <br/>
