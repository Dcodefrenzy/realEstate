             ...
             for (var i = 0,  j = data.blogs.length; i < j;  i++) {
               ...
               var tr = document.createElement("tr");
                ...
                var editLink = document.createElement("a");
                 editLink.href = "/editBlog?hash_id="+data.blogs[i].hash_id;
                 var deleteLink = document.createElement("a");
                 deleteLink.href = "/deleteBlog?hash_id="+data.blogs[i].hash_id;
                 var img = document.createElement("img");
                 img.className = "img-responsive";
                 img.src = data.blogs[i].file_path;
                


                editButton.className = "btn btn-common btn-sm";
                editButton.value = data.blogs[i].hash_id;
                editButton.id = "edit";
                editButton.type ="submit";

                button.className = "btn btn-danger btn-sm";
                button.value = data.blogs[i].hash_id;
                button.id = "button";
                button.type = "submit";
                ...
                title.append(data.blogs[i].title);
                author.append(data.blogs[i].author);
                body.append(data.blogs[i].body)
                imageTd.appendChild(img);
               /* img.append(data.blogs[i].file_path);*/
                dateTd.append(data.blogs[i].date_created);
                hashTd.append(data.blogs[i].hash_id);
                admin_id.append(data.blogs[i].admin_id);
